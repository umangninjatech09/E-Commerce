...
def delete_search_index(db: Session, obj: SearchIndex):
 ...
 """
 - Solve error in search-service
    - Add search by customer name
    - Add search by product description
    - Add search by pricing amount
    - Add search by inventory details
    - Ensure all search functionalities are working correctly
    - Write tests to validate the search functionalities
    - Refactor code for better readabilit
 """