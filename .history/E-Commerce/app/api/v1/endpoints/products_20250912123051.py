...
@router.get("/inventory", response_model=List[ProductWithInventory])
def api_list_products_with_inventory(db: Session = Depends(get_db)):
    return get_all_products_with_inventory(db)
