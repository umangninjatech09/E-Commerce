...
def create_order(order: schemas.OrderCreate, db: Session = Depends(get_db)):
    ...
    try:
        ...
        if response.status_code != 200:
            return HTTPException(404, "CustomerNotFound", f"Customer with id={order.customer_id} does not exist.")
    except httpx.RequestError:
        return HTTPException(503, "CustomerServiceUnavailable", "Cannot reach Customer Service.")
