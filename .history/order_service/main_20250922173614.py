...
from order_service.auth import get_oauth_token, verify_token
from fastapi.responses import JSONResponse
from order_service.middleware import jwt_middleware 
...
async def create_order(order: schemas.OrderCreate, db: Session = Depends(get_db), token_data: dict = Depends(verify_token)):
    # Validate customer
